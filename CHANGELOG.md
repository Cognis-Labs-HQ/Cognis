...
- Locale strings `ui.adapter.notify.internal.mark_all_read`, `ui.adapter.notify.internal.empty`, and `ui.adapter.notify.internal.always_on` added to all four language files (en, de, ja, id). ([TBD](https://github.com/le-firehawk/Cognis/commit/TBD))
