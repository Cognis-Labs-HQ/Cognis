...
- Dashboard clock widget: live digital/analogue clock added as a page-composer element. Displays the current time in the user's effective timezone (from `getEffectiveTimezone()`); a toggle button switches between digital and analogue SVG face. The element is user-removable and serves as a live demonstration of the timezone feature. ([e990f3e](https://github.com/le-firehawk/Cognis/commit/e990f3e))
