    ...
    register(
        ...
        async ({ args, apiBaseUrl, getApiToken }) => {
            ...
            requireArgs(
                args,
                ["moduleId"],
                "cognisctl modules:enable <moduleId>",
            );
        ...
        },
        {
            ...
            render: (payload) =>
                renderModuleMutation("Module Enabled", payload),
        },
    );
    ...
    register(
        ...
        async ({ args, apiBaseUrl, getApiToken }) => {
            ...
            requireArgs(
                args,
                ["moduleId"],
                "cognisctl modules:disable <moduleId>",
            );
        ...
        },
        {
            ...
            render: (payload) =>
                renderModuleMutation("Module Disabled", payload),
        },
    );
}
