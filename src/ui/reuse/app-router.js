 ...
 *   navigateTo(path, options) — navigate in-app with optional history state.
...
export async function navigateTo(
    ...
    if (
        ...
        !requestRouteNavigation(path, () =>
            navigateTo(path, { bypassGuard: true, state }),
        )
    )
        return false;
