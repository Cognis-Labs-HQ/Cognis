 ...
 *
 * Public exports:
 *   createSubComposerHandlers(deps) — returns the nested grid mounting,
 *     rendering, editing, and persistence helpers.
 *
 * Usage:
 *   const subComposer = createSubComposerHandlers({ i18n, UNIT, beginEditMode, endEditMode, getGridSize, getSubPanelId, getComposerPanelSafeTop, clampComposerPanelLeft, buildDropZoneLine, loadLayoutFor, saveLayoutFor, cloneLayoutData, captureFormState, restoreFormState, mergeFormStateSnapshots, loadPersistedFormState, bindFormDraftPersistence, computeSubViewPlacements, syncSubEditToggle });
 *
 * @param {object} deps
 * @returns {object}
 */
...
export function createSubComposerHandlers({
    i18n, UNIT, beginEditMode, endEditMode, getGridSize, getSubPanelId,
    getComposerPanelSafeTop, clampComposerPanelLeft, buildDropZoneLine,
    loadLayoutFor, saveLayoutFor, cloneLayoutData, captureFormState,
    restoreFormState, mergeFormStateSnapshots, loadPersistedFormState,
    bindFormDraftPersistence, computeSubViewPlacements, syncSubEditToggle,
}) {
    ...
    return { mountSubComposer, unmountSubComposer, renderSubGrid, compactSubPlacements, };
}
