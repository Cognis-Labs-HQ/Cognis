...
await renderDashboardLayout(root, {
  ...
  content: `<article class="content-panel"><table><thead><tr><th>${i18n.t('ui.reuse.id')}</th><th>${i18n.t('ui.reuse.version')}</th><th>${i18n.t('ui.reuse.class')}</th><th>${i18n.t('ui.reuse.actions')}</th></tr></thead><tbody>${rows}</tbody></table></article>`
});
