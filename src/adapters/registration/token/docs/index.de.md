...
Bei geschlossener öffentlicher Registrierung hält Cognis den authentifizierten Anbieterzustand hinter einer undurchsichtigen, ablaufenden Vorgangs-ID und zeigt das Tokenformular dieses Adapters in der standardmäßigen Registrierungshülle. Die Registerkarte „E-Mail“ versendet Einladungen per SMTP; die Registerkarte „Token“ erstellt einen gebundenen Registrierungslink ohne E-Mail-Versand. Öffentliche Registrierung überspringt die Tokenstufe. Gründungsbenutzer können höchstens zehn erfolgreiche Registrierungen ermöglichen. Administratoren können dieses Kontingent zurücksetzen; nur Eigentümer können Einladungen durch Gründer oder Administratoren unter Administration → Registrierung deaktivieren.
