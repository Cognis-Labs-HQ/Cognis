...
Existing compound-writing-unit cards use the same provider-labelled pronunciation carousel as creation. Editing is selection-only: it updates the stored atomic references in carousel order without exposing a misleading nested-create action.
