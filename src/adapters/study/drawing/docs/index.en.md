...
Guidance always presents a complete canonical stroke. As assistance diminishes, whole guides are omitted rather than shortened, while repeated misses restore the next complete guide. Pointer input is painted at most once per animation frame to keep the pad stable.
