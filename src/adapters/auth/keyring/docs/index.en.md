...
The browser-facing keyring remains the reusable `src/ui/reuse/keyring.js` surface. Encryption and decryption happen in the browser; the adapter never receives plaintext secrets.
