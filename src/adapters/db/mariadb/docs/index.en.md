...
Commands against tables created by raw initialization SQL also recover from MariaDB datetime rejections, including fully qualified column names in server errors, by retrying once with canonical MariaDB temporal parameters.
