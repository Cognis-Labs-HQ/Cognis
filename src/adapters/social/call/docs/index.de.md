...
Komponentenanbieter schließen die Auflösung möglicherweise erst ab, nachdem der ursprüngliche Klick beendet ist. Die Anrufoberfläche erfasst deshalb beim Starten oder Annehmen synchron die einmal verwendbare Komponenten-Startberechtigung des Kerns und übergibt sie an die spätere Komponentenmontage. Die Berechtigung läuft nach 60 Sekunden ab und kann kein zweites Fenster autorisieren.

Beim Verschieben einer aktiven Komponente in Bild-in-Bild wird, sofern verfügbar, die zustandserhaltende DOM-Verschiebung des Browsers verwendet. Dadurch bleiben eingebettete Konferenzmedien und Verbindungen ohne erneutes Einbinden bestehen. Das Entfernen der Komponente wird ab dem erfolgreichen Einbinden überwacht, nicht erst nach dem Wechsel zu Bild-in-Bild. Ein vom Anbieter beendetes Meeting entfernt daher sofort die Anrufoberfläche und stellt die Unterhaltung wieder her.
