...
- Berkontribusi `auth:accountStore`, `auth:createLocalAdmin`, dan `auth:getLoginMethods` ke capability store.
...
| `GET`  | `/auth/line/callback`                        | Endpoint callback LINE yang dikelola Cognis | Tidak diperlukan |
