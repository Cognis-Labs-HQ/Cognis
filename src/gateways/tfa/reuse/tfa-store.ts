...
export class DbTfaStore {
  ...
  async ensureSchema(): Promise<void> {
    await this.db.ensureTable({
      ...
      columns: [
        { name: 'adapter_id', type: 'text', notNull: true, primaryKey: true },
    ...
    await this.db.ensureTable({
      ...
      columns: [
        ...
        { name: 'state_json', type: 'text', notNull: true, default: '{}' },
        { name: 'configured_at', type: 'text' },
        { name: 'updated_at', type: 'text', notNull: true, default: '' },
      ],
    ...
    await this.db.ensureTable({
      ...
      columns: [
        { name: 'setup_id', type: 'text', notNull: true, primaryKey: true },
        { name: 'account_id', type: 'text', notNull: true },
        { name: 'method_id', type: 'text', notNull: true },
        { name: 'payload_json', type: 'text', notNull: true, default: '{}' },
        { name: 'created_at', type: 'text', notNull: true, default: '' },
        { name: 'expires_at', type: 'text', notNull: true, default: '' },
      ],
    ...
    await this.db.ensureTable({
      ...
      columns: [
        { name: 'settings_id', type: 'text', notNull: true, primaryKey: true },
        {
