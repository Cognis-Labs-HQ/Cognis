/**
 * Social profile avatar: authenticated fetch with initials fallback.
 *
 * Provides a unified mechanism for fetching and rendering profile avatar
 * images across all social gateway UI components. Callers only need to
