...
| `external` | Arsip `.zip` atau `.tar.gz` yang diunggah         | Melalui API admin atau CLI `component:import-github` | Ditampilkan sebelum diaktifkan |
...
1. Admin mengirim `repositoryUrl` dan `versionTag` lewat UI Administration atau `cognisctl component:import-github`.
