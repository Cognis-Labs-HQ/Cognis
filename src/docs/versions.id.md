...
| Share                 | `src/gateways/share/`         | `1.7.11` |
...
| Calendar              | `src/gateways/calendar/`      | `1.4.92` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.4.31` |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.3.3`  |
