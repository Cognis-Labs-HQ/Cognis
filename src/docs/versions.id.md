...
| Link Share            | `src/adapters/share/link/`          | `1.1.28` |
...
| Share                 | `src/gateways/share/`         | `1.7.21` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.4.40` |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.3.7`  |
