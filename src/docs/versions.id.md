...
| Encrypted Keyring     | `src/adapters/auth/keyring/`        | `1.0.11` |
...
| Messages (Social)     | `src/adapters/social/messages/`     | `2.0.10` |
...
| Authentication (auth) | `src/gateways/auth/`         | `1.7.29` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.24` |
