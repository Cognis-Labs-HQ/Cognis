...
| Link Share            | `src/adapters/share/link/`          | `1.1.13` |
...
| Share                 | `src/gateways/share/`         | `1.6.55` |
...
| Calendar              | `src/gateways/calendar/`      | `1.4.78` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.75` |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.52` |
