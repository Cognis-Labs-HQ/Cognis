...
| User Keyring          | `src/adapters/auth/keyring/`        | `1.0.17` |
...
| Messages (Social)     | `src/adapters/social/messages/`     | `2.0.18` |
...
| Calendar              | `src/gateways/calendar/`     | `1.4.30` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.32` |
