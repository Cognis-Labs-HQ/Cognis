...
| Messages (Social)     | `src/adapters/social/messages/`     | `2.0.56` |
...
| Share                 | `src/gateways/share/`         | `1.7.18` |
...
| Calendar              | `src/gateways/calendar/`      | `1.4.94` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.4.37` |
