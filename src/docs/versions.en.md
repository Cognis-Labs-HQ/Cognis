...
| Messages (Social)     | `src/adapters/social/messages/`     | `2.0.59` |
| Link Share            | `src/adapters/share/link/`          | `1.1.30` |
...
| Calendar              | `src/gateways/calendar/`      | `1.4.97` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.4.42` |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.3.9`  |
