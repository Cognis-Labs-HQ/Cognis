...
| Link Share            | `src/adapters/share/link/`          | `1.1.14` |
...
| Share                 | `src/gateways/share/`         | `1.6.57` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.77` |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.54` |
