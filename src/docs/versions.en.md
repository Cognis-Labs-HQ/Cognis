...
| Link Share            | `src/adapters/share/link/`          | `1.1.19` |
...
| Share                 | `src/gateways/share/`         | `1.6.67` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.87` |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.64` |
