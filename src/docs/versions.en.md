...
| Profile (Social)      | `src/adapters/social/profile/`      | `1.1.52` |
| Messages (Social)     | `src/adapters/social/messages/`     | `2.0.48` |
...
| Share                 | `src/gateways/share/`         | `1.6.93` |
...
| Calendar              | `src/gateways/calendar/`      | `1.4.81` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.4.4`  |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.83` |
