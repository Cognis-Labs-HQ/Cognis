...
| Encrypted Keyring     | `src/adapters/auth/keyring/`        | `1.0.8`  |
...
| Messages (Social)     | `src/adapters/social/messages/`     | `2.0.7`  |
...
| Authentication (auth) | `src/gateways/auth/`         | `1.7.26` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.21` |
