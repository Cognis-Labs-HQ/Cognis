...
| File Quota            | `src/adapters/file/quota/`          | `1.0.15` |
...
| Library (Study)       | `src/adapters/study/library/`       | `2.6.59` |
| Progress (Study)      | `src/adapters/study/progress/`      | `1.0.0`  |
...
| Study                 | `src/gateways/study/`         | `1.8.14`  |
