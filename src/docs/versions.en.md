...
| Classes (Study)       | `src/adapters/study/classes/`       | `1.2.0` |
...
| Study                 | `src/gateways/study/`        | `1.5.0` |
...
| Cognis Japanese  | `src/modules/study/languages/ja/` | `1.1.4` |
| Cognis English   | `src/modules/study/languages/en/` | `1.0.0` |
