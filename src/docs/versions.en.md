...
| Link Share            | `src/adapters/share/link/`          | `1.1.15` |
...
| Share                 | `src/gateways/share/`         | `1.6.58` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.78` |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.55` |
