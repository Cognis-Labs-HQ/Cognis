...
| Share                 | `src/gateways/share/`         | `1.7.20` |
...
| Calendar              | `src/gateways/calendar/`      | `1.4.95` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.4.39` |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.3.6`  |
