...
| Console Logging       | `src/adapters/logging/console/`     | `1.1.1`  |
| File Logging          | `src/adapters/logging/file/`        | `1.1.2`  |
...
| Logging               | `src/gateways/logging/`       | `1.5.6`  |
