...
| Internal Notification | `src/adapters/notify/internal/`     | `0.5.27` |
...
| Messages (Social)     | `src/adapters/social/messages/`     | `2.7.5`  |
| Calls (Social)        | `src/adapters/social/call/`         | `0.5.15` |
...
| Component    | Path        | Version  |
| ------------ | ----------- | -------- |
| Core Package | `src/core/` | `0.3.86` |

## API

| Component  | Path       | Version |
| ---------- | ---------- | ------- |
| API Server | `src/api/` | `0.5.2` |
