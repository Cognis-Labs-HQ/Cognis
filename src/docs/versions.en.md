...
| Profile (Social)      | `src/adapters/social/profile/`      | `1.1.8` |
| Messages (Social)     | `src/adapters/social/messages/`     | `1.4.10` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.2.15` |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.1.42` |
