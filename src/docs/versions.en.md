...
| Share                 | `src/gateways/share/`        | `1.6.19` |
...
| Calendar              | `src/gateways/calendar/`     | `1.4.19` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.3` |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.3` |
