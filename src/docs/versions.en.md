...
| --------------------- | ----------------------------------- | ------- |
| SMTP Notification     | `src/adapters/notify/smtp/`         | `0.2.3` |
...
| Two-Factor (tfa)      | `src/gateways/tfa/`          | `1.1.4`  |
| Notification (notify) | `src/gateways/notify/`       | `1.4.10` |
