...
## Balanced upcoming meeting details

Upcoming meeting rows now keep the ID column compact while balancing the remaining detail columns, show the creator display name with the creation date in the Created By field, and label the final column as Schedule Date so it reflects when the meeting is scheduled to start.
