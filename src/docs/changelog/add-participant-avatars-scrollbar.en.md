...
When a private chat is opened from the avatar strip, a return button appears so users can switch back to the meeting chat quickly. The most recently loaded meeting chat remains active after leaving the meeting.
