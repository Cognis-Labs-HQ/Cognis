...
Konten pengguna dan administrator yang dirender sebagai Markdown kini otomatis mengubah URL HTTP dan HTTPS polos menjadi hyperlink yang aman.

## Tautan non-HTTP tetap teks
