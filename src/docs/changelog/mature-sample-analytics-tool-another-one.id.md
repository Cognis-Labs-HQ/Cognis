...
Endpoint baru `POST /api/v1/modules/sample-analytics/events` memungkinkan admin
...
`/api/v1/modules/sample-analytics/metrics` (ringkasan dan rincian peran),
`/api/v1/modules/sample-analytics/series` (deret pendaftaran harian), dan
`/api/v1/modules/sample-analytics/events` (log acara kustom terbaru).
