...
Saving from the user verification step now runs the authentication test automatically when needed. A failed authentication test returns the administrator to the LDAP bind fields for correction.
