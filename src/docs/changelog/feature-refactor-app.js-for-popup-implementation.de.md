...
## Study-eigene Browser-Infrastruktur

Study-SPA-Routen, die Ermittlung von Kindkomponenten, Cache-Invalidierung und der Bibliotheks-Detailablaufvertrag liegen nun im Study-Gateway. Zentrales Routing und globale Suchzuordnung enthalten keine Study-spezifischen Pfade, APIs, Selektoren oder Komponentenmetadaten mehr.
