...
## Failing checks repaired

Authentication password resets, in-memory database joins, UI source checks, component boundaries, and stale regression expectations now behave consistently.
