...
## Gateway-owned registration client and reusable error reporting

The registration page now obtains Authentication registration configuration through the Authentication gateway UI client, keeping endpoint and response-contract knowledge with its owner. Basic local browser error reporting has moved into a neutral reusable UI module consumed by the login page.
