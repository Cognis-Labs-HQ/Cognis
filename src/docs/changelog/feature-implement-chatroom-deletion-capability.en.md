...
Replaced the search popup's character close control and browser-provided input clear control with consistent SVG icons for light and dark themes. The input clear icon is smaller and partially transparent, while multi-select checkboxes now sit beside user details instead of above them.
