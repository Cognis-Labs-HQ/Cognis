...
Authentication providers can now register a removable, branded login button with a required same-origin icon and full localized label. Cognis validates the presentation contract and keeps the icon and full-width label visible on small and large screens.
