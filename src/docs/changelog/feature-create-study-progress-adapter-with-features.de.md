...
## Korrekte Erkennung der Identität von Kindkarten

Die Variantenanzeige vergleicht jetzt neben Datenbank-IDs auch die stabile Identität des Quelldatensatzes. Doppelte Darstellungen derselben logischen Karte werden nicht mehr als Eltern- und Kindkarte angezeigt, während echte Kindvarianten verfügbar bleiben.

## Stabile Detail-Pop-ups und zusammengeführte Bibliothekskarten
...
## Lokalisierte Library-Beschriftungen wiederherstellen
...
## Untergeordnete Karten beim Darüberfahren deckend halten

Untergeordnete Karten verwenden beim Darüberfahren, Fokussieren und Aktivieren jetzt mit höherer Spezifität eine deckende, erhöhte Oberfläche und ausdrücklich volle Deckkraft. Die Darstellung überfahrener Elternkarten bleibt unverändert, während gestapelte Kindkarten keine Beschriftungen oder Formen darunterliegender Karten mehr durchscheinen lassen.
