...
Search popups now include controls for whole-word matching, regular expressions, and case-sensitive matching.
...
## Search categories are easier to scan

Global search now shows matched result categories below the search controls whenever multiple categories are returned, making broad searches easier to understand before reviewing individual matches.
