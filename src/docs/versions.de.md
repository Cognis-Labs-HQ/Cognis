...
| Share                 | `src/gateways/share/`        | `1.6.38` |
...
| Calendar              | `src/gateways/calendar/`     | `1.4.34` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.36` |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.21` |
