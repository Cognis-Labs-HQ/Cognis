...
| Profile (Social)      | `src/adapters/social/profile/`      | `1.1.44` |
| Messages (Social)     | `src/adapters/social/messages/`     | `2.0.39` |
...
| Calendar              | `src/gateways/calendar/`      | `1.4.72` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.62` |
