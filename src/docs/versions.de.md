...
| Share                 | `src/gateways/share/`         | `1.6.99` |
...
| Calendar              | `src/gateways/calendar/`      | `1.4.86` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.4.13` |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.91` |
