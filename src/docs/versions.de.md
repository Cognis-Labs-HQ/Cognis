...
| --------------------- | ----------------------------------- | -------- |
| SMTP Notification     | `src/adapters/notify/smtp/`         | `0.2.16` |
...
| SMTP TFA              | `src/adapters/tfa/smtp/`            | `1.0.16` |
...
| Profile (Social)      | `src/adapters/social/profile/`      | `1.1.29` |
...
| Calendar              | `src/gateways/calendar/`      | `1.4.50` |
...
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.33` |
