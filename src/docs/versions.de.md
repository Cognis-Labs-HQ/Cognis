...
| Link Share            | `src/adapters/share/link/`          | `1.1.18` |
...
| Share                 | `src/gateways/share/`         | `1.6.65` |
...
| Calendar              | `src/gateways/calendar/`      | `1.4.79` |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.85` |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.62` |
