...
`createPageComposer` is the layout orchestration utility for all Cognis pages. It manages widget placement, persistence, editing, sub-page navigation, toolbar slots, and floating menus — so individual page modules only declare *what* to render, not *how* to arrange it.
...
document.querySelector('#app [data-some-toolbar-btn]')
