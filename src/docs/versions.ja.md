...
| Encrypted Keyring     | `src/adapters/auth/keyring/`        | `1.0.1`    |
...
| Authentication (auth) | `src/gateways/auth/`         | `1.7.20`   |
| Share                 | `src/gateways/share/`        | `1.6.28`   |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.14`   |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.12`   |
