...
| Link Share            | `src/adapters/share/link/`          | `1.1.16`   |
...
| Share                 | `src/gateways/share/`         | `1.6.59`   |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.79`   |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.56`   |
