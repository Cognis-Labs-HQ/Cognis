...
| Link Share            | `src/adapters/share/link/`          | `1.1.17`   |
...
| Share                 | `src/gateways/share/`         | `1.6.61`   |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.81`   |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.58`   |
