...
| Share                 | `src/gateways/share/`        | `1.6.40`   |
...
| Calendar              | `src/gateways/calendar/`     | `1.4.37`   |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.38`   |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.23`   |
