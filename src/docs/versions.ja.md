...
| Messages (Social)     | `src/adapters/social/messages/`     | `2.0.22`   |
...
| Authentication (auth) | `src/gateways/auth/`         | `1.7.39`   |
...
| Calendar              | `src/gateways/calendar/`     | `1.4.40`   |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.3.41`   |
