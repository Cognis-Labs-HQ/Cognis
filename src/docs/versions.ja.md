...
| Profile (Social)      | `src/adapters/social/profile/`      | `1.1.51`   |
| Messages (Social)     | `src/adapters/social/messages/`     | `2.0.47`   |
...
| Share                 | `src/gateways/share/`         | `1.6.91`   |
...
| Jitsi Meet           | `src/modules/jitsi-meet/`           | `1.4.3`    |
| Nextcloud Whiteboard | `src/modules/nextcloud-whiteboard/` | `2.2.81`   |
